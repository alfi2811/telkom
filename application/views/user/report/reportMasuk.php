                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-auto">
                            ...
                            <button type="submit" name="reportM" class="btn btn-primary"><i class="fas fa-fw fa-save pr-2"></i>Get Report</button>
                        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="table-responsive">
                        ...
                        <?php if (!empty($reportM)) : ?>
                            <form action="<?= base_url('user/excelSm/' . $tgl_dari . '/' . $tgl_sampai . "/")   . $dispo  ?>" method="post">
