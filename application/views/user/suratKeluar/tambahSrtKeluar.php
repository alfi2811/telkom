<div class="container-fluid">
    <div class="user">
        <div class="row">
            <div class="col-10">
                <h1 style="font-size: 24px; color:black">Data <small style="font-size: 60%">Surat Keluar > Insert</small> </h1>
            </div>
            <div class="col-2">
            </div>
        </div>
                    ...
                    <div class="col-7">
                        ...
                        <form action="<?= base_url('user/tambahSuratKeluar') ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="no_sk" id="no_msk">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type='text' name="tgl_sk" class="form-control" id='datepicker'>
