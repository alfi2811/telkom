<div class="container-fluid">
    <div class="user">
        <div class="row">
            <div class="col-10">
                <h1 style="font-size: 24px; color:black">Data <small style="font-size: 60%">Surat Keluar > Ubah</small> </h1>
            </div>
            <div class="col-2">
            </div>
        </div>
                    ...
                    <div class="col-7">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="no_sk" id="no_msk" value="<?= $sm['no_sk'] ?>">
                                    <?= form_error('no_sk', '<small class="form-text text-danger">', '</small>'); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type='text' name="tgl_sk" class="form-control" id='datepicker' value="<?= $sm['tgl_sk'] ?>">
                                    <?= form_error('tgl_sk', '<small class="form-text text-danger">', '</small>'); ?>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword" class="col-sm-3 text-right col-form-label">Pengirim</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="pengirim" id="pengirim" value="<?= $sm['pengirim_sk'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="hidden" name="old_image" value="<?= $sm['file_sk'] ?>">
                                    ...
                                    <a href="<?= base_url('user/suratKeluar') ?>" class="btn btn-secondary mt-3"><i class="fas fa-fw fa-undo pr-2"></i>Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
