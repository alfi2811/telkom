<div class="container-fluid">
    <div class="user">
        <div class="row">
            <div class="col-10">
                <h1 style="font-size: 24px; color:black">Master <small style="font-size: 60%">Disposisi > Insert</small> </h1>
            </div>
            <div class="col-2">
            </div>
        </div>
                    ...
                    <div class="col-6">
                        ...
                        <form action="<?= base_url('user/tambahDisposisi') ?>" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="nama_dis" id="nama_dis">
